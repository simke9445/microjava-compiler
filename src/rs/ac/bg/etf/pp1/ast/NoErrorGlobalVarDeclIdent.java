...
public class NoErrorGlobalVarDeclIdent extends GlobalVarDeclIdent {

    private VarDeclIdent VarDeclIdent;

    public NoErrorGlobalVarDeclIdent (VarDeclIdent VarDeclIdent) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NoErrorGlobalVarDeclIdent(\n");
